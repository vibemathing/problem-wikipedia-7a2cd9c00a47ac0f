...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-7a2cd9c00a47ac0f"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-7a2cd9c00a47ac0f",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-7a2cd9c00a47ac0f",
        "url": "https://en.wikipedia.org/wiki/Sum_of_four_cubes_problem"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Can every integer be written as a sum of four perfect cubes?",
      "version": 1
    },
    "title": "Can every integer be written as a sum of four perfect cubes?",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "14cc3772d7cbaea0901876a22bd79779ec19d9003d2421411acaeefc7687733a"
}
```
